...
- **Copilot benytter `.github/copilot-session.md` i samme mappe som `.github/copilot-instructions.md`, - som tilleggsalternativ for å supplimenteres til `chat`-vinduet, (for- generell copilot-interfacing"), - om plausibelt.**
